...
u8 weaknesspolicy_bs[] = {0x45, 10, 7, 0, 0, 0, 0, 0x83, 8, 0, 0x6A, 10, 0x3E, 0x3E};
u8 ejectbutton_bs[] = {0x10, 0xA2, 0x1, 0x12, 0x40, 0, 0x6A, 0, 0x50, 10, 0, 0, 0, 0, 0xE2, 10, 0x3A, 0x51, 10, 0x2, 0x58, 10, 0x4C, 10, 0x4D, 10, 0x73, 10, 0x10, 3, 0, 0x4E, 10, 1, 0x3A, 0x52, 10, 0x3E};
u8 can_switch_bs[] = {0x50, 0x8A, 1, 0, 0, 0};
u8 rockyhelmet_bs[] = {0x45, 1, 0x0F, 0, 0, 0, 0, 0xB, 1, 0xC, 1, 0x10, 0xA3, 0x1, 0x12, 0x40, 0, 0x19, 1, 0, 0, 0, 0, 0, 0x3E};
u8 balloonpops_bs[] = {0x10, 0xA4, 0x1, 0x12, 0x39, 0, 0x6A, 0, 0x3E};
u8 destinyknot_bs[] = {0x65, 1, 0, 0, 0xF, 0, 0x10, 0xA2, 0x1, 0x12, 0x40, 0x0, 0x10, 0xA5, 0x1, 0x12, 0x40, 0, 0x3E};
...
u8 mentalherb_bs[] = {0x45, 10, 7, 0, 0, 0, 0, 0x83, 9, 0, 0x6A, 10, 0x3E};
u8 disable_end_bs[] = {0x10, 0x86, 0, 0x12, 0x40, 0, 0x3C};
u8 encore_end_bs[] = {0x10, 0x88, 0, 0x12, 0x40, 0, 0x3C};
u8 healblock_end_bs[] = {0x10, 0xA5, 0, 0x12, 0x40, 0, 0x3C};
