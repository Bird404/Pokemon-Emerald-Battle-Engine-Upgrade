...
u8 symbiosispass_bs[] = {0x45, 0, 0x10, 0, 0, 0, 0, 0x10, 0xB6, 1, 0x12, 0x40, 0, 0x3C};
u8 symbiosispass2_bs[] = {0x45, 0, 0x10, 0, 0, 0, 0, 0x10, 0xB6, 1, 0x12, 0x40, 0, 0x3E};
...
u8 powder_bs[] = {2, 3, 0x10, 0xE5, 0, 0x12, 0x40, 0, 0xB, 1, 0xC, 1, 0x19, 1, 0, 0, 0, 0, 0, 0x28, 0x4E, 0x8A, 0x2D, 0x08};
