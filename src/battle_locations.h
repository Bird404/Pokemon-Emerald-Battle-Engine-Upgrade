...
u8 text_Ally[5];
u8 text_Ally_[6];
u8 text_ENIGMA_BERRY[13];
u8 text__BERRY[7];
u8 text_BOX_IS_FULL[19];
u8 castform_form[4];
u8 viewing_recorded_battle;
u16 no_of_recorded_bytes[4];
u16 var_800D_lastresult;
u16 var_800E_last_used_item;
u16 randomly_chosen_move;
s16 bg2X_battle;
s16 bg2Y_battle;
u8 battle_some_link_id;
u8 script_text_buffer1[0x100];
u8 script_text_buffer2[0x100];
u8 script_text_buffer3[0x100];
u8 text_someones[10];
u8 text_LANETTES[10];
u8 text_yesno_battle[15];
u8 sent_pokes_to_opponent[2];
u16 expshare_exp;
u8 bank_in_menu;
