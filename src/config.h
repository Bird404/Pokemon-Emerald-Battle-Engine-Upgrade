...
// Only change these when you want to adjust the position of mega icons if you want to change the HP bars
...
//form indexes
#define POKE_CHERRIM_SUNSHINE 0x9
#define POKE_ZEN_MODE 0x4
#define POKE_AEGISLASH_BLADE 0x1
